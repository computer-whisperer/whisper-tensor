...
impl DType {
    pub fn from_safetensors(dtype: safetensors::Dtype) -> Result<Self, Error> {
        match dtype {
            ...
            safetensors::Dtype::F8_E4M3 => Ok(DType::F8E4M3FN),
...
impl TensorDataValue {
    pub fn len(&self) -> usize {
        match self {
            ...
            TensorDataValue::F8E4M3FN(v) => v.len(),
    ...
    pub fn dtype(&self) -> DType {
        match self {
            ...
            TensorDataValue::F8E4M3FN(_) => DType::F8E4M3FN,
    ...
    pub fn get_raw_encoding(&self) -> Vec<u8> {
        match self {
            ...
            TensorDataValue::F8E4M3FN(v) => v.iter().map(|x| x.to_bits()).collect(),
...
impl From<Vec<float8::F8E4M3>> for TensorDataValue {
    fn from(value: Vec<float8::F8E4M3>) -> Self {
        TensorDataValue::F8E4M3FN(value)
    }
}
...
impl TensorData {
    ...
    pub fn zeros(shape: Shape, dtype: DType) -> Result<Self, Error> {
        match dtype {
            ...
            DType::F8E4M3FN => Self::fill(shape, float8::F8E4M3::ZERO),
