...
// ----------------- Cranelift JIT implementation (cranelift_1) -----------------
...
impl CraneliftBuilder {
    ...
    fn define_matmul_func(module: &mut JITModule, m: i64, n: i64, k: i64) -> (cranelift_module::FuncId, String) {
        ...
        ctx.func.name = cranelift_codegen::ir::UserFuncName::user(0, 1);
        ...
        let func_id = module
            .declare_function("matmul_f32_cl1", Linkage::Local, &ctx.func.signature)
...
impl MatmulImpl for CraneliftImpl {
    fn name(&self) -> &'static str { "cranelift_1" }
