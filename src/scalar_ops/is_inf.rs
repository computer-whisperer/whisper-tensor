...
pub fn float_is_inf(raw: u64, ft: &FloatType, detect_positive: bool, detect_negative: bool) -> u64 {
    ...
    let hit = (detect_positive && v == f64::INFINITY)
...
mod tests {
    ...
    fn float_is_inf_both() {
        ...
        assert_eq!(float_is_inf(ft.encode_f64(f64::INFINITY), &ft, true, true), 1);
        assert_eq!(float_is_inf(ft.encode_f64(f64::NEG_INFINITY), &ft, true, true), 1);
    ...
    fn float_is_inf_positive_only() {
        ...
        assert_eq!(float_is_inf(ft.encode_f64(f64::INFINITY), &ft, true, false), 1);
        assert_eq!(float_is_inf(ft.encode_f64(f64::NEG_INFINITY), &ft, true, false), 0);
    }
    ...
    fn float_is_inf_negative_only() {
        ...
        assert_eq!(float_is_inf(ft.encode_f64(f64::INFINITY), &ft, false, true), 0);
        assert_eq!(float_is_inf(ft.encode_f64(f64::NEG_INFINITY), &ft, false, true), 1);
    }
    ...
    fn float_is_inf_neither() {
        ...
        assert_eq!(float_is_inf(ft.encode_f64(f64::INFINITY), &ft, false, false), 0);
        assert_eq!(float_is_inf(ft.encode_f64(f64::NEG_INFINITY), &ft, false, false), 0);
    }
    ...
    fn float_is_inf_f4e2m1() {
        ...
        assert_eq!(float_is_inf(ft.encode_f64(f64::INFINITY), &ft, true, true), 0);
    }
}
