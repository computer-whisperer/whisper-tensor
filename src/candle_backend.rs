...
impl TryFrom<&NDArrayNumericTensor> for candle_core::Tensor {
...
impl TryFrom<&candle_core::Tensor> for NDArrayNumericTensor {
    type Error = NumericTensorError;
    fn try_from(value: &candle_core::Tensor) -> Result<Self, Self::Error> {
        ...
        Ok(match value.dtype() {
            candle_core::DType::F64 => {
                ...
                NDArrayNumericTensor::F64(ArcArray::from_shape_vec(shape, v).map_err(NDArrayNumericTensorError::ShapeError)?)
            },
            candle_core::DType::U8 => {
                let v = tensor_flat.to_vec1::<u8>()?;
                NDArrayNumericTensor::U8(ArcArray::from_shape_vec(shape, v).map_err(NDArrayNumericTensorError::ShapeError)?)
            }
            candle_core::DType::U32 => {
                let v = tensor_flat.to_vec1::<u32>()?;
                NDArrayNumericTensor::U32(ArcArray::from_shape_vec(shape, v).map_err(NDArrayNumericTensorError::ShapeError)?)
            }
            candle_core::DType::I64 => {
                let v = tensor_flat.to_vec1::<i64>()?;
                NDArrayNumericTensor::I64(ArcArray::from_shape_vec(shape, v).map_err(NDArrayNumericTensorError::ShapeError)?)
            }
            candle_core::DType::BF16 => {
                let v = tensor_flat.to_vec1::<half::bf16>()?;
                NDArrayNumericTensor::BF16(ArcArray::from_shape_vec(shape, v).map_err(NDArrayNumericTensorError::ShapeError)?)
            }
            candle_core::DType::F16 => {
                let v = tensor_flat.to_vec1::<half::f16>()?;
                NDArrayNumericTensor::F16(ArcArray::from_shape_vec(shape, v).map_err(NDArrayNumericTensorError::ShapeError)?)
            }
            candle_core::DType::F32 => {
                let v = tensor_flat.to_vec1::<f32>()?;
                NDArrayNumericTensor::F32(ArcArray::from_shape_vec(shape, v).map_err(NDArrayNumericTensorError::ShapeError)?)
            }
        })
    }
}
...
impl TryFrom<NumericTensor> for candle_core::Tensor {
    ...
    fn try_from(value: NumericTensor) -> Result<Self, Self::Error> {
        Ok(match value {
            ...
            _ => candle_core::Tensor::try_from(NDArrayNumericTensor::try_from(value)?)?
        })
    }
}
