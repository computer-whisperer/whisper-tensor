...
fn find_deepseek_v3_dir() -> Option<PathBuf> {
    let candidates = [
        "/ceph/public/neural_models/llms/DeepSeek-V3-0324",
        "/ceph/public/neural_models/llms/DeepSeek-V3",
        "/ceph/public/neural_models/llms/DeepSeek-R1-0528",
        "/ceph/public/neural_models/llms/DeepSeek-R1",
    ];
    for c in candidates {
        let p = Path::new(c);
